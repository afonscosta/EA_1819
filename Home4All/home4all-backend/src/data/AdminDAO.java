...
public class AdminDAO {
	...
	public static boolean save(Admin admin) throws PersistentException {
		try {
			Home4AllPersistentManager.instance().saveObject(admin);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Admin admin) throws PersistentException {
		try {
			Home4AllPersistentManager.instance().deleteObject(admin);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Admin admin) throws PersistentException {
		try {
			Home4AllPersistentManager.instance().getSession().refresh(admin);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Admin admin) throws PersistentException {
		try {
			Home4AllPersistentManager.instance().getSession().evict(admin);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
