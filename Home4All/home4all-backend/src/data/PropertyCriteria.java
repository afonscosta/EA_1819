...
public class PropertyCriteria extends AbstractORMCriteria {
	...
	public PropertyCriteria(PersistentSession session) {
		this(session.createCriteria(Property.class));
	}
	
	public PropertyCriteria() throws PersistentException {
	...
	public Property uniqueProperty() {
		return (Property) super.uniqueResult();
	}
