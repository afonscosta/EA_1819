...
public class Home4AllPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Home4All";
	...
	private Home4AllPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Home4AllPersistentManager();
		}
