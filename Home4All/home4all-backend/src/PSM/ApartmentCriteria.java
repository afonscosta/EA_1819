...
public class ApartmentCriteria extends AbstractORMCriteria {
	...
	public ApartmentCriteria(Criteria criteria) {
		super(criteria);
	...
	public ApartmentCriteria(PersistentSession session) {
		this(session.createCriteria(Apartment.class));
	}
	
	public ApartmentCriteria() throws PersistentException {
	...
	public Apartment uniqueApartment() {
		return (Apartment) super.uniqueResult();
	}
	
	public Apartment[] listApartment() {
