...
public class PropertyDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public PropertyDetachedCriteria() {
		super(PSM.Property.class, PSM.PropertyCriteria.class);
	...
	public PropertyDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, PSM.PropertyCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		ownerId = new IntegerExpression("owner.ID", this.getDetachedCriteria());
		owner = new AssociationExpression("owner", this.getDetachedCriteria());
		typologyId = new IntegerExpression("typology.ID", this.getDetachedCriteria());
	...
	public Property uniqueProperty(PersistentSession session) {
		return (Property) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Property[] listProperty(PersistentSession session) {
