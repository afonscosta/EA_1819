...
public class SharedDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public SharedDetachedCriteria() {
		super(PSM.Shared.class, PSM.SharedCriteria.class);
		...
		pets = new IntegerExpression("pets", this.getDetachedCriteria());
	...
	public SharedDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, PSM.SharedCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		ownerId = new IntegerExpression("owner.ID", this.getDetachedCriteria());
		owner = new AssociationExpression("owner", this.getDetachedCriteria());
		typologyId = new IntegerExpression("typology.ID", this.getDetachedCriteria());
	...
	public PSM.BedroomDetachedCriteria createBedroomsCriteria() {
		return new PSM.BedroomDetachedCriteria(createCriteria("ORM_Bedrooms"));
	}
	
	public PSM.OccupationDetachedCriteria createOccupationsCriteria() {
		return new PSM.OccupationDetachedCriteria(createCriteria("ORM_Occupations"));
	}
