...
public class VillaDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public VillaDetachedCriteria() {
		super(PSM.Villa.class, PSM.VillaCriteria.class);
	...
	public VillaDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, PSM.VillaCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		ownerId = new IntegerExpression("owner.ID", this.getDetachedCriteria());
		owner = new AssociationExpression("owner", this.getDetachedCriteria());
		typologyId = new IntegerExpression("typology.ID", this.getDetachedCriteria());
	...
	public Villa uniqueVilla(PersistentSession session) {
		return (Villa) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Villa[] listVilla(PersistentSession session) {
