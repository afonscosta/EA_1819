...
public class PrivateDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public PrivateDetachedCriteria() {
		super(PSM.Private.class, PSM.PrivateCriteria.class);
	...
	public PrivateDetachedCriteria(DetachedCriteria aDetachedCriteria) {
		super(aDetachedCriteria, PSM.PrivateCriteria.class);
		ID = new IntegerExpression("ID", this.getDetachedCriteria());
		ownerId = new IntegerExpression("owner.ID", this.getDetachedCriteria());
		owner = new AssociationExpression("owner", this.getDetachedCriteria());
		typologyId = new IntegerExpression("typology.ID", this.getDetachedCriteria());
	...
	public Private uniquePrivate(PersistentSession session) {
		return (Private) super.createExecutableCriteria(session).uniqueResult();
	}
	
	public Private[] listPrivate(PersistentSession session) {
