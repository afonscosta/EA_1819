...
public class VillaDAO {
	...
	public static Villa loadVillaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Villa) session.load(PSM.Villa.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Villa getVillaByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Villa) session.get(PSM.Villa.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Villa loadVillaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Villa) session.load(PSM.Villa.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Villa getVillaByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Villa) session.get(PSM.Villa.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryVilla(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From PSM.Villa as Villa");
		if (condition != null)
	...
	public static Villa createVilla() {
		return new PSM.Villa();
	}
	
	public static boolean save(PSM.Villa villa) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().saveObject(villa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(PSM.Villa villa) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().deleteObject(villa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(PSM.Villa villa)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(PSM.Villa villa, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (villa.getOwner() != null) {
				villa.getOwner().properties.remove(villa);
			}
	...
	public static boolean refresh(PSM.Villa villa) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().getSession().refresh(villa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(PSM.Villa villa) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().getSession().evict(villa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
