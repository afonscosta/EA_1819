...
public class UsersDAO {
	...
	public static Users loadUsersByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Users) session.load(PSM.Users.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Users getUsersByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Users) session.get(PSM.Users.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Users loadUsersByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Users) session.load(PSM.Users.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Users getUsersByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Users) session.get(PSM.Users.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUsers(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From PSM.Users as Users");
		if (condition != null)
	...
	public static Users createUsers() {
		return new PSM.Users();
	}
	
	public static boolean save(PSM.Users users) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().saveObject(users);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(PSM.Users users) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().deleteObject(users);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(PSM.Users users) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().getSession().refresh(users);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(PSM.Users users) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().getSession().evict(users);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
