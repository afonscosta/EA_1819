...
public class SharedDAO {
	...
	public static Shared loadSharedByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Shared) session.load(PSM.Shared.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Shared getSharedByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Shared) session.get(PSM.Shared.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Shared loadSharedByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Shared) session.load(PSM.Shared.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Shared getSharedByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Shared) session.get(PSM.Shared.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryShared(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From PSM.Shared as Shared");
		if (condition != null)
	...
	public static Shared createShared() {
		return new PSM.Shared();
	}
	
	public static boolean save(PSM.Shared shared) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().saveObject(shared);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(PSM.Shared shared) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().deleteObject(shared);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(PSM.Shared shared)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(PSM.Shared shared, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (shared.getOwner() != null) {
				shared.getOwner().properties.remove(shared);
			}
	...
	public static boolean refresh(PSM.Shared shared) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().getSession().refresh(shared);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(PSM.Shared shared) throws PersistentException {
		try {
			PSM.Home4AllPersistentManager.instance().getSession().evict(shared);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
