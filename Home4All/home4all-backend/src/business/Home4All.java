...
public class Home4All {
    ...
    public static Common updateCommonUser(int id, String email, String name, String password, String birthdate, String phone,
                                          String gender, String occupation)
            throws PersistentException, GenderNotExistentException, OccupationNotExistentException, ParseException {
        return usersBean.updateCommonUser(id, email, name, password, birthdate, phone, gender, occupation);
    }
